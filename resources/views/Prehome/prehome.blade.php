...
{{-- DA CONFLICTO CON LOS ESTILOS DE BOOTSTRAP --}}
...
<head>
    ...
    @vite(['resources/js/app.js', 'resources/sass/app.scss', 'resources/css/prehome.css', 'resources/css/app.css', 'resources/js/gotop.js', 'resources/js/arr-flights-national.js', 'resources/js/dep-flights-national.js', 'resources/js/all-flights-national.js'])
...
<body>
        ...
        <div id="inicio">
            <div class="inicio container">
                <div>
                    ...
                    <p>Para ingresar al sistema, inicia sesión</p>
                ...
                <div class="vuelo-top">
                    ...
                    <div class="card">
                        <div class="card-title">
                            <div id="watch" class="text-center hora-p"></div>
                        </div>
                        <div class="card-body">
                            {{-- Setup data for datatables --}}
                            @php
                                $heads = ['Hora Estimada', 'Hora Iteneraria', 'Codigo Aerolinea', 'No. Vuelo', 'Origen', 'Estado', 'L S', 'Tipo Vuelo'];
                                // $heads = ['ID', 'Hora Estimada', 'Hora Iteneraria', 'Codigo Aerolinea', 'No. Vuelo', 'Origen', 'Estado', 'L S', 'Tipo Vuelo','create','update'];
                                
                                $vuelos = App\Models\Flight::All(); //Obtener los datos de tu tabla en el controlador y asignarlos a la variable $vuelos
                                
                                $data = [];
                                foreach ($vuelos as $vuelo) {
                                    $data[] = [$vuelo->estimated_time, $vuelo->itenary_hour, $vuelo->airline_code, $vuelo->flight_number, $vuelo->origin, $vuelo->state, $vuelo->ll_s, $vuelo->flight_type];
                                    // $data[] = [$vuelo->id,
                                    // $vuelo->estimated_time,
                                    // $vuelo->itenary_hour,
                                    // $vuelo->airline_code,
                                    // $vuelo->flight_number,
                                    // $vuelo->origin,
                                ...
                                $config = [
                                    'data' => $data,
                                    'order' => [[5, 'asc']], //el num es la posición de la columna que escogera para ordenar | desc(descendiente), asc(ascendiente)
                                    ...
                                    'columns' => [null, null, null, null, null, null, null, null], //8
                                    // 'columns' => [null, null, null, null, null, null, null, null, null, null, null], //11
                                ];
                                // dd($data);
                            @endphp
                            ...
                            <div class="">
                                {{-- table-responsive --}}
                                <x-adminlte-datatable id="table2" :heads="$heads" theme="light" :config="$config"
                                    hoverable beautify striped>
                                    {{-- @foreach ($vuelos as $row)
                            <tr>
                                <td>{{ $row['id'] }}</td>
                                <td>{{ $row['estimated_time'] }}</td>
                                <td>{{ $row['itenary_hour'] }}</td>
        ...
        <div id="estadisticas">
            <div class="estadisticas container">
                <div class="estadisticas-top">
                    <h1 class="section-title text-center">Estadisticas</h1>

                    <div class="row">
                        <div class="col-md-6">
                          <!-- Contenido de la primera columna -->
                          <div class="my-content">
                            <h5>Operaciones de Vuelos Nacionales que llegaron</h5>
                            <canvas id="Grafica1vnll" width="800" height="400" class="chartjs-render-monitor" ></canvas>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <!-- Contenido de la segunda columna -->
                          <div class="my-content">
                            <h5>Operaciones de Vuelos Nacionales que salieron</h5>
                            <canvas id="Grafica2vnll" width="800" height="400" class="chartjs-render-monitor" ></canvas>
                          </div>
                        </div>
                      </div>
                      <canvas id="Graficall" width="800" height="400" class="chartjs-render-monitor"></canvas>
                ...
                <div class="row">
                        ...
                        <div id="carouselExampleDark" class="carousel slide carousel-fade" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active" data-bs-interval="10000">
                                    <img src="imgs/20220308_141854.jpg" class="d-block w-100 overlay-image img-fluid">
                                ...
                                <div class="carousel-item" data-bs-interval="10000">
                                    <img src="imgs/logo-aerocali-big.png"
                                        class="d-block w-100 overlay-image img-fluid">
                                    <div class="carousel-caption d-none d-md-block">
                                        <h5>Noticia 2</h5>
                    ...
                    <div class="col">
                        ...
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="imgs/logo-aerocali-big.png" class="img-fluid rounded-start">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <button type="button" class="btn btn-secondary btn-flat">Mas
                                                    información</button>
                                            </div>
                                        </div>
    ...
    <!-- Agrega esto en la sección <head> de tu página -->
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script>
        var dates = @json($dates);
        console.log(dates, 'vista plantilla');
        window.nacionalLlegadaCounts1 = @json($nacionalLlegadaCounts1);
        window.nacionalLlegadaCounts2 = @json($nacionalLlegadaCounts2);
        window.nacionalSalidaCounts1 = @json($nacionalSalidaCounts1);
        window.nacionalSalidaCounts2 = @json($nacionalSalidaCounts2);
        window.namesallNa = @json($namesallNa);
        window.countsallNa = @json($countsallNa);
    </script>
    {{-- <script src="{{assets/js/passengers-flights.js}}"></script> --}}
